...
| Возможность | Что проверять | Ссылка/Маршрут |
|------------|---------------|----------------|
| Просмотр списка заявок | Все заявки отображаются с именем, email, телефоном и сообщением | [Перейти](http://127.0.0.1:8000/admin/leads) |
| Редактирование статуса заявки | Статус можно менять через выпадающий список; после изменения значение сохраняется в базе | [Перейти](http://127.0.0.1:8000/admin/leads) (выпадающий список у каждой заявки) |
| Просмотр комментариев | Под каждой заявкой отображаются комментарии с автором и текстом | [Перейти](http://127.0.0.1:8000/admin/leads) (список комментариев под заявкой) |
